...
import com.mycompany.store.domain.enumeration.Measurement;
...
class ProductResourceIT {
    ...
    private static final Measurement DEFAULT_MEASUREMENT = Measurement.S;
    private static final Measurement UPDATED_MEASUREMENT = Measurement.M;
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getMeasurement()).isEqualTo(DEFAULT_MEASUREMENT);
    ...
    @Test
    @Transactional
    void checkMeasurementIsRequired() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().size();
        // set the field null
    ...
    void putNewProduct() throws Exception {
        ...
        assertThat(testProduct.getMeasurement()).isEqualTo(UPDATED_MEASUREMENT);
