...
export class ProductUpdatePage {
  ...
  measurementSelect = element(by.id('field_measurement'));
  ...
  async setMeasurementSelect(measurement: string): Promise<void> {
    await this.measurementSelect.sendKeys(measurement);
  }

  async getMeasurementSelect(): Promise<string> {
    return await this.measurementSelect.element(by.css('option:checked')).getText();
  }

  async measurementSelectLastOption(): Promise<void> {
    await this.measurementSelect.all(by.tagName('option')).last().click();
  }
